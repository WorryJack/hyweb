...
import com.emms.comp.BDS.LZTRAINADDCom;
 ...
 * 
 */
@Stateless(name = "LZTRAINADDService", mappedName = "LZTRAINADDService")
@Local(IBusinessService.class)
public class LZTRAINADDService implements IBusinessService {

	/** 输入输出参数常量定义 **/
	private static final String IN_PARAM_IN_VT_QD_QDCZ = "IN_XT_ADD_LIANGZI";
	...
	public Map<String, Object> runService(Map<String, Object> requestParam)
		...
		System.out.println("$$$$$$$$$$$$$"+param1.getTqbs());//$$$$$$$$$$$$$PKID000000000565   $$$$$$$$$$$$$PKID000000000565
		LZTRAINADDCom com = new LZTRAINADDCom();
